...
type ItemIssuseTableSaleInProps = {
...
const ItemIssuseTableSaleIn: React.FC<ItemIssuseTableSaleInProps> = ({
  onData,
  gridDataresponse,
}) => {
  ...
  const handleCheckBoxChange = (row: any) => {
    ...
    updatedSelectedValues[row] = {
      ...
      qtyKgs: updatedSelectedValues[row].qtyKgs,
      invoiceQty: updatedSelectedValues[row].invoiceQty,
      iTag3001: updatedSelectedValues[row].iTag3001,
  ...
  const handleQuantityBlur = (row: number) => {
    const updatedSelectedValues = [...selectedValues];
    if (
      updatedSelectedValues?.[row]?.invoiceQty === '' ||
      updatedSelectedValues?.[row]?.invoiceQty === '0'
    ) {
      updatedSelectedValues[row] = {
        sVoucherNo: updatedSelectedValues[row].sVoucherNo,
        AccountId: updatedSelectedValues[row].AccountId,
        ...
        Unit: updatedSelectedValues[row].Unit,
        OrdQty: updatedSelectedValues[row].OrdQty,
        invoiceQty: `${updatedSelectedValues[row].Balance}`,
        qtyKgs: updatedSelectedValues[row].qtyKgs,
        iTag3001: updatedSelectedValues[row].iTag3001,
        isRowSelected: updatedSelectedValues[row].isRowSelected,
      };
    ...
    if (
      ...
      if (!validRate) {
        ...
        updatedSelectedValues[row] = {
          ...
          Unit: updatedSelectedValues[row].Unit,
          OrdQty: updatedSelectedValues[row].OrdQty,
          invoiceQty: text.replace(
            /^0+/,
            `${updatedSelectedValues[row].Balance}`,
          ),
          qtyKgs: updatedSelectedValues[row].qtyKgs,
          iTag3001: updatedSelectedValues[row].iTag3001,
          ...
          {selectedValues.map((item: any, row: number) => (
            <View
              ...
              <TextInput
                ...
                value={item?.invoiceQty || ''} // Set the initial value with an attribute
...
export default ItemIssuseTableSaleIn;
