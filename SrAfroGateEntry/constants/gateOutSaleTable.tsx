...
const GateOutSaleTable: React.FC<ItemIssueTableProps> = ({
  onData,
  gridDataresponse,
}) => {
  ...
  const handleCheckBoxChange = (row: any) => {
    ...
    updatedSelectedValues[row] = {
      ...
      VehicleNo: updatedSelectedValues[row].VehicleNo,
      ...
      iProduct: updatedSelectedValues[row].iProduct,
      iTag3001: updatedSelectedValues[row].iTag3001,
      iUnit: updatedSelectedValues[row].iUnit,
      Unit: updatedSelectedValues[row].Unit,
      qty: updatedSelectedValues[row].qty,
...
export default GateOutSaleTable;
