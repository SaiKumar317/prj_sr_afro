...
import VisitorInPage from '../pages/VisitorInPage';
...
function VisitorsIn({
  ...
  const reloadPage = () => {
    ...
    console.log('reloadPageV', reloadKey);
  };
    ...
    try {
      ...
      console.log(
        ...
        gateInPurchasePage &&
          ...
          // gateInPurchasePage?.fromPlace &&
          // gateInPurchasePage?.toMeet &&
      ...
      if (
        ...
        if (storedHostname) {
          ...
          if (
            ...
            gateEntryInUrl = `${storedHostname}/focus8api/Transactions/7987/`;
              ...
              data: [
                {
                  ...
                  Header: {
                    ...
                    VehicleNo: vehicleNo || '',
                    Image1: {
                      FileName: `visitor_in${dateToInt(new Date())}_${
                        getIntDate?.data[0]?.Table[0]?.Time
                      }.jpg`,
